...
class DataValidation:
    ...
    def validate_dataset_schema(self) -> bool:
        try:
            ...
            dict = read_yaml_file(file_path = r'D:\Insurance_ml_Project\Insurance_Premium_Predection\config\schema.yaml')['columns']
            ...
            if sorted(train_df.columns.to_list()) == sorted(test_df.columns.to_list()) == sorted(schema_file_columns):
                ...
                sex_yaml_col_value = sorted(read_yaml_file(file_path = r'D:\Insurance_ml_Project\Insurance_Premium_Predection\config\schema.yaml')['domain_value']['sex'])
                region_yaml_col_value = sorted(read_yaml_file(file_path = r'D:\Insurance_ml_Project\Insurance_Premium_Predection\config\schema.yaml')['domain_value']['region'])
